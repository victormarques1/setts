  ...
  return (
    <>
      <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="mx-auto flex h-12 max-w-2xl items-center justify-between gap-3 px-4 sm:h-14 sm:px-6">
          <Link
            href="/workouts"
      ...
      >
        <div className="mx-auto flex max-w-2xl items-stretch pb-[env(safe-area-inset-bottom)]">
          {navItems.map((item) => (
            <NavLink
              key={item.href}
              item={item}
